...
afterLogIn : function(src) {
    ...
    sys.sendHtmlMessage(src, "HOW TO PLAY: (PA) 🌿 /start bulbasaur <span><font size=3 font color=red> /start charmander</span> or 💧/start squirtle We recommend. You finish /tutorial however you may wish to /skiptutorial confirm for additional guidelines about contests type /info you can view are shop to buy pokemon balls. Using /buy like /buy bait:1 anyway. Here's extra help commands /commands safari /help safari rules /commands to see the commands good luck have fun");

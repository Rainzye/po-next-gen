...
afterLogIn : function(src) {
    ...
    if (sys.name(src) == "haunter") {
    	sys.sendHtmlAll("<timestamp/><span style='color: " + sys.getColor(src) + "'><b><font size=3 font color=#000000>God has arrived <img src='pokemon:num=43' width=20 height=20></font> " + sys.name(src) + "</span><font size=2 font color=red> joined ", 0);

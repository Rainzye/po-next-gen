...
afterLogIn : function(src) {
    ...
    if (sys.name(src) == "Dreko") {
    	sys.sendHtmlAll("<timestamp/><span style='color: " + sys.getColor(src) + "'><b><font size=3 font color=#cc0000>[Administrator]</font> " + sys.name(src) + "</span><font size=3 font color=orange> Joined the channel! height=10><img src='pokemon:num=717&gen=6' height=10>", 0);
